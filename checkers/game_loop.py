...
# TODO :force take (all options) -> modify code so that a moves list of all pieces created instead of just the
#  selected piece but still highlights the selected pieces moves
# TODO: Highlight the pieces that are forced to move because they can take
# TODO: double jump when king
# TODO: Reformat
